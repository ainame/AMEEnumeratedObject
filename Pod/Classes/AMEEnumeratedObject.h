 ...
 * give ordinal and name value to enum object.
 * `name` value can be used in `[AMEEnumerateCollection valueForName]`.
 * can give `stringValue` as a human readable or underlying value this.
 *
 * @param ordinal ordinal value to set property
 * @param name name value to set property
 * @param stringValue string value to set property
 * @return self instance
 */
 ...
 * if you don't given this initializer, will return the `name` property's value.
 */
